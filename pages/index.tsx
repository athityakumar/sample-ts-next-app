...
const Home: NextPage = () => {
  ...
  return (
    ...
    <div className={`dark:bg-indigo-600 bg-white scroll-smooth text-black`}>
    <DarkModeToggle
    ...
    />
      ...
      <main className={styles.main}>
        <h1 className={`${styles.title} dark:text-white blur-[1px] text-black`}>
          Welcome to <a href="https://nextjs.org" className='dark:text-green-500'>Next.js!</a>
        </h1>
        <span className="animate-bounce w-6 h-6 hover:animate-pulse blur-sm hover:blur-none">Scroll below</span>

        <p className={styles.description}>
          Get started by editing{' '}
          <code className={`${styles.code} text-black bg-white dark:text-white dark:bg-black`}>pages/index.tsx</code>
        </p>
